...
const prompt = `Use Google Search to find each NBA team's CURRENT projected rotation for the 2026-27 season (latest trades, free agency, draft, depth charts). Base everything on what you find.
...
- impact: estimated on-court value as net points per 100 possessions, -4..9 (stars 5-9, solid starters 1-4, role players -2..1).
- min: projected minutes per game (starters 28-38, bench 12-26).
- exp: NBA seasons of experience (a rookie is 0).
Honor current facts from search: e.g. the Lakers are built around Luka Doncic (Anthony Davis is in Dallas); Washington features #1 pick AJ Dybantsa.
