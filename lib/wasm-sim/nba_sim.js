 ...
 */
export function simulate_game(home_rating, away_rating, sims) {
    const ret = wasm.simulate_game(home_rating, away_rating, sims);
 ...
 * @returns {Float64Array}
 */
export function simulate_playoffs_from_seeds(east, west, ratings, sims) {
    ...
    const ret = wasm.simulate_playoffs_from_seeds(ptr0, len0, ptr1, len1, ptr2, len2, sims);
 ...
 * @returns {Float64Array}
 */
export function simulate_playoffs_full(ratings, conf, home, away, sims) {
    const ptr0 = passArrayF64ToWasm0(ratings, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(conf, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray32ToWasm0(home, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray32ToWasm0(away, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.simulate_playoffs_full(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, sims);
 ...
 * @returns {Float64Array}
 */
export function simulate_season(ratings, conf, home, away, sims) {
    const ptr0 = passArrayF64ToWasm0(ratings, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(conf, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const ptr3 = passArray32ToWasm0(away, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.simulate_season(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, sims);
    var v5 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 8, 8);
    return v5;
}
